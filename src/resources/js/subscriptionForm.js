...
function sendPaymentDataToAnet(target, eraseData) {
    ...
    authData.clientKey = document.querySelector("#authorizeKeys").getAttribute('data-clientkey');
    authData.apiLoginID = document.querySelector("#authorizeKeys").getAttribute('data-apiLoginId');
